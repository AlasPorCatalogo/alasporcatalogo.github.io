...
if (ejecutar == true) {
  ...
  if (inputElement.inputMode == 'text' && celdasascroll.length < 1) {
...
if (busquedaciudades != inputElement.value.toLowerCase()) {
  logElement.innerText = `${logElement.innerText} ${lineadesalto}Encontradas ${conteolog} zonas en esta ciudad`
}
...
console.log(conteolog, celdasascroll);
