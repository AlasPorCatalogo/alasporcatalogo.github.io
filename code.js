var Indicelistas, listazonas, listaciudades, conteo, conteocsstablas, conteolog, eastereggtonto, elementoccss, timeoutID, IDaCeldas, IDenCeldas, AgregarID, Busquedacelda, zonam2, logElement, conteobusqueda, submitElement, inputElement, zonaIaEC, conteotransparencia, aoc, columna, zonaspresentes, lineadesalto;
...
function agregarciudades(easteregg) {
conteo = 0;
conteolog = 0;
columna = 0;
if (!AgregarID) {
...
if (easteregg == 'Intencionado'){eastereggtonto = 1;}else if(eastereggtonto != 1){eastereggtonto = 0;}
}
function clearMessage() {
if (eastereggtonto == 0){console.log('Tienes solo',5,'segundos para detenerlo así que refresca y dale al botón');}
else if(eastereggtonto == 1){console.log('No pudes detener lo comenzado')}
else{console.log('Evento detenido exitosamente');}
...
//setTimeout(function() {cambiarcss('avon2');}, 50);
//setTimeout(function() {aaaaaaa();}, 50);
timeoutID = setTimeout(function() {agregarciudades();}, 3000);